...
if(isset($_POST['username']) && isset($_POST['password'])){
    ...
    $user= pg_query($conn, "select * from User_, artist where username = '$username' and password = '$password' and artist.user__username = User_.username" );
...
<main>
    <div class="container">
        ...
        <div class="botao_register"><a href="RegisterArtist.php"><img src="Icones%20Rockstar%20Inc/Login/botao%20register.png" height="auto" width="179" alt="img"></a></div>
